...
public class DingTalkMessageService implements NotifierService {
     ...
     * 通用的钉钉markdown格式发送逻辑
     */
    private void sendDingTalkMarkdownMessage(String title, String text, List<String> atMobiles) {//向钉钉机器人发送 Markdown 格式的消息通知
        Map<String, Object> markdown = new HashMap<>();
        markdown.put("title", title);
        markdown.put("text", text);

        Map<String, Object> at = new HashMap<>();//指定需要@的手机号
